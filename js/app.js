/**
 * Dynamite Sports Learner – Bowling Coach
...
function openChat() {
    ...
    announceToScreenReader('Chat window opened. Your Bowling coach is ready to help!');
...
// ===== LOG INITIALIZATION =====
console.log('🏓 Dynamite Sports Learner – Bowling Coach loaded successfully!');
